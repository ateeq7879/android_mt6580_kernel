...
#define GC0310MIPI_TEST_PATTERN_CHECKSUM 0x4e908d1c
...
void GC0310MIPIGammaSelect(kal_uint32 GammaLvl)
{
	switch(GammaLvl)
	{
		case GC0310MIPI_RGB_Gamma_m1:						//smallest gamma curve
			...
			GC0310MIPI_write_cmos_sensor(0xbf,0x04);
			GC0310MIPI_write_cmos_sensor(0xc0,0x10);
			GC0310MIPI_write_cmos_sensor(0xc1,0x22);
			GC0310MIPI_write_cmos_sensor(0xc2,0x3e);
			GC0310MIPI_write_cmos_sensor(0xc3,0x5b);
			GC0310MIPI_write_cmos_sensor(0xc4,0x70);
			GC0310MIPI_write_cmos_sensor(0xc5,0x7f);
			GC0310MIPI_write_cmos_sensor(0xc6,0x96);
			GC0310MIPI_write_cmos_sensor(0xc7,0xa9);
			GC0310MIPI_write_cmos_sensor(0xc8,0xb7);
			GC0310MIPI_write_cmos_sensor(0xc9,0xc5);
			GC0310MIPI_write_cmos_sensor(0xca,0xcf);
			GC0310MIPI_write_cmos_sensor(0xcb,0xd8);
...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x41,0x25); //21
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82,0x04); //08
	GC0310MIPI_write_cmos_sensor(0x83,0x08); //0b
	...
	GC0310MIPI_write_cmos_sensor(0x8c,0x08); //
	GC0310MIPI_write_cmos_sensor(0x8d,0x10); //	
	///////////////////////////////////////////////// 
	//////////////////   EEINTP  ////////////////////
	///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x8f,0xaa); 
	GC0310MIPI_write_cmos_sensor(0x90,0x8c); //8c
	GC0310MIPI_write_cmos_sensor(0x91,0x10); //90
	GC0310MIPI_write_cmos_sensor(0x92,0x02); //03
	GC0310MIPI_write_cmos_sensor(0x93,0x02); //03
	GC0310MIPI_write_cmos_sensor(0x94,0x05); //05
	GC0310MIPI_write_cmos_sensor(0x95,0x1a); //65
	GC0310MIPI_write_cmos_sensor(0x96,0xa0); 
	...
	GC0310MIPI_write_cmos_sensor(0x9d,0x68); //80 //50
	 
	GC0310MIPI_write_cmos_sensor(0xa1,0x30);
 	GC0310MIPI_write_cmos_sensor(0xa2,0x22); //32
	GC0310MIPI_write_cmos_sensor(0xa4,0x50); //30
	GC0310MIPI_write_cmos_sensor(0xa5,0x10); //30
	...
	GC0310MIPI_write_cmos_sensor(0xbf,0x03);//04
	GC0310MIPI_write_cmos_sensor(0xc0,0x0b);//10
	GC0310MIPI_write_cmos_sensor(0xc1,0x1d);//22
	GC0310MIPI_write_cmos_sensor(0xc2,0x38);//3e
	GC0310MIPI_write_cmos_sensor(0xc3,0x5b);
	GC0310MIPI_write_cmos_sensor(0xc4,0x70);
	GC0310MIPI_write_cmos_sensor(0xc5,0x7f);
	GC0310MIPI_write_cmos_sensor(0xc6,0x96);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x22); //34//20
	GC0310MIPI_write_cmos_sensor(0xd2,0x22); //34//20
	GC0310MIPI_write_cmos_sensor(0xd3,0x37); //40 
	...
	GC0310MIPI_write_cmos_sensor(0x13,0x3d); //38
	GC0310MIPI_write_cmos_sensor(0x18,0x95); 
	GC0310MIPI_write_cmos_sensor(0x19,0x96); 
	GC0310MIPI_write_cmos_sensor(0x1f,0x80); //20//40
	GC0310MIPI_write_cmos_sensor(0x20,0x40); //c0//e0
	...
	GC0310MIPI_write_cmos_sensor(0x67,0x84);////a2
	GC0310MIPI_write_cmos_sensor(0x69,0x08);//
	GC0310MIPI_write_cmos_sensor(0x6a,0x05);//
	GC0310MIPI_write_cmos_sensor(0x6b,0x00);//
	GC0310MIPI_write_cmos_sensor(0x6c,0x00);// 
	GC0310MIPI_write_cmos_sensor(0x6d,0x02);// 
	GC0310MIPI_write_cmos_sensor(0x6e,0xf0);// 
	GC0310MIPI_write_cmos_sensor(0x6f,0xa0);//80 
	GC0310MIPI_write_cmos_sensor(0x76,0x80);//
	GC0310MIPI_write_cmos_sensor(0x77,0x60);
	GC0310MIPI_write_cmos_sensor(0x78,0x90);//af// f0   a0   summer
	GC0310MIPI_write_cmos_sensor(0x79,0x60);//79
...
/*
	...
	GC0310MIPI_write_cmos_sensor(0x98,0x1c);
	GC0310MIPI_write_cmos_sensor(0x9a,0x46);
	GC0310MIPI_write_cmos_sensor(0x9b,0x1c);
	GC0310MIPI_write_cmos_sensor(0x9c,0xc2);
	GC0310MIPI_write_cmos_sensor(0x9d,0x47);
	...
	GC0310MIPI_write_cmos_sensor(0xa6,0xbb);
	...
	GC0310MIPI_write_cmos_sensor(0xb0,0xcb);
	...
	*/
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	GC0310MIPI_write_cmos_sensor(0x90,0x00);
	GC0310MIPI_write_cmos_sensor(0x91,0x00);
	GC0310MIPI_write_cmos_sensor(0x92,0xff);
	GC0310MIPI_write_cmos_sensor(0x93,0xe0);
	GC0310MIPI_write_cmos_sensor(0x95,0x2d);//1e
	GC0310MIPI_write_cmos_sensor(0x96,0x01);
	GC0310MIPI_write_cmos_sensor(0x97,0x52);
	GC0310MIPI_write_cmos_sensor(0x98,0x2d);
	GC0310MIPI_write_cmos_sensor(0x9a,0x51);
	GC0310MIPI_write_cmos_sensor(0x9b,0x2d);
	GC0310MIPI_write_cmos_sensor(0x9c,0x96);
	GC0310MIPI_write_cmos_sensor(0x9d,0x52);
	GC0310MIPI_write_cmos_sensor(0x9f,0x80);
	GC0310MIPI_write_cmos_sensor(0xa0,0x80);
	GC0310MIPI_write_cmos_sensor(0xa1,0x00);
	GC0310MIPI_write_cmos_sensor(0xa2,0x00);
	GC0310MIPI_write_cmos_sensor(0x86,0x00);
	GC0310MIPI_write_cmos_sensor(0x87,0x00);
	...
	GC0310MIPI_write_cmos_sensor(0xa5,0x00);
	GC0310MIPI_write_cmos_sensor(0xa6,0xc9);
	GC0310MIPI_write_cmos_sensor(0xa7,0xa2);
	GC0310MIPI_write_cmos_sensor(0xa9,0xca);
	GC0310MIPI_write_cmos_sensor(0xaa,0xa0);
	GC0310MIPI_write_cmos_sensor(0xab,0xad);
	GC0310MIPI_write_cmos_sensor(0xac,0x92);
	GC0310MIPI_write_cmos_sensor(0xae,0xca);
	GC0310MIPI_write_cmos_sensor(0xaf,0xad);
	GC0310MIPI_write_cmos_sensor(0xb0,0xcb);
	GC0310MIPI_write_cmos_sensor(0xb1,0xa6);
	GC0310MIPI_write_cmos_sensor(0xb3,0x00);
	GC0310MIPI_write_cmos_sensor(0xb4,0x00);
	GC0310MIPI_write_cmos_sensor(0xb5,0x00);
	GC0310MIPI_write_cmos_sensor(0xb6,0x00);
	GC0310MIPI_write_cmos_sensor(0x8b,0x00);
	GC0310MIPI_write_cmos_sensor(0x8c,0x00);
	GC0310MIPI_write_cmos_sensor(0x8d,0x00);
	GC0310MIPI_write_cmos_sensor(0x8e,0x00);
	GC0310MIPI_write_cmos_sensor(0x94,0x50);
	GC0310MIPI_write_cmos_sensor(0x99,0xaa);
	GC0310MIPI_write_cmos_sensor(0x9e,0xaa);
	GC0310MIPI_write_cmos_sensor(0xa3,0x00);
	GC0310MIPI_write_cmos_sensor(0x8a,0x00);
	GC0310MIPI_write_cmos_sensor(0xa8,0x50);
	GC0310MIPI_write_cmos_sensor(0xad,0x55);
	GC0310MIPI_write_cmos_sensor(0xb2,0x55);
	GC0310MIPI_write_cmos_sensor(0xb7,0x00);
	GC0310MIPI_write_cmos_sensor(0x8f,0x00);
	...
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
   /*                             
	GC0310MIPI_write_cmos_sensor(0xd0,0x40);//3a//
	GC0310MIPI_write_cmos_sensor(0xd1,0xfa);//fd//
	GC0310MIPI_write_cmos_sensor(0xd2,0x04);//08
	GC0310MIPI_write_cmos_sensor(0xd3,0xf4);//fa//
	GC0310MIPI_write_cmos_sensor(0xd4,0x46);//44//
	GC0310MIPI_write_cmos_sensor(0xd5,0xec);//fc//

	GC0310MIPI_write_cmos_sensor(0xd6,0x42);//40//
	GC0310MIPI_write_cmos_sensor(0xd7,0xf6);//f2//04//
	GC0310MIPI_write_cmos_sensor(0xd8,0x02);//0a//
	GC0310MIPI_write_cmos_sensor(0xd9,0xfe);//16//
	GC0310MIPI_write_cmos_sensor(0xda,0x44);//36//
	GC0310MIPI_write_cmos_sensor(0xdb,0xea);//e6//f6//
	*/
	GC0310MIPI_write_cmos_sensor(0xd0,0x42);//40
	GC0310MIPI_write_cmos_sensor(0xd1,0xf0);//f4
	GC0310MIPI_write_cmos_sensor(0xd2,0xfd);

	GC0310MIPI_write_cmos_sensor(0xd3,0xf0);//ec
	GC0310MIPI_write_cmos_sensor(0xd4,0x48);
	GC0310MIPI_write_cmos_sensor(0xd5,0xed);


	GC0310MIPI_write_cmos_sensor(0xd6,0x40);//46 summer
	GC0310MIPI_write_cmos_sensor(0xd7,0xf8);//f8
	GC0310MIPI_write_cmos_sensor(0xd8,0x05);//05
	GC0310MIPI_write_cmos_sensor(0xd9,0x08);//08
	GC0310MIPI_write_cmos_sensor(0xda,0x3b);//44
	GC0310MIPI_write_cmos_sensor(0xdb,0xe9);//e9
...
*/
	...
	/*
	GC0310MIPI_write_cmos_sensor(0xc4,0x75);//70
	GC0310MIPI_write_cmos_sensor(0xc5,0x49);//44
	GC0310MIPI_write_cmos_sensor(0xc6,0x49);//44
	*/
	GC0310MIPI_write_cmos_sensor(0xc4,0x70);//90   summer
	GC0310MIPI_write_cmos_sensor(0xc5,0x49);//69
	GC0310MIPI_write_cmos_sensor(0xc6,0x49);//69
	GC0310MIPI_write_cmos_sensor(0xc7,0x14);//20
	GC0310MIPI_write_cmos_sensor(0xc8,0x00);//10
	GC0310MIPI_write_cmos_sensor(0xc9,0x00);//10
	...
	GC0310MIPI_write_cmos_sensor(0x2b,0x06); //6.25fps//7.14fps 5cc
	GC0310MIPI_write_cmos_sensor(0x2c,0xa0); 
...
BOOL GC0310MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_n10:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x13, 0x2a);
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;					
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_NIGHTMODE:
			//GC0310MIPI_night_mode((BOOL) *feature_data);
		break;
