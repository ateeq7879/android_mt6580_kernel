...
SP0A20_write_cmos_sensor(0xfd,0x01);
SP0A20_write_cmos_sensor(0xeb,0x68);
SP0A20_write_cmos_sensor(0xec,0x78);
...
SP0A20_write_cmos_sensor(0xaf,0x06);
...
SP0A20_write_cmos_sensor(0x9e,0xe9);
SP0A20_write_cmos_sensor(0x9f,0xee);
SP0A20_write_cmos_sensor(0xa0,0xf1);
SP0A20_write_cmos_sensor(0xfd,0x02);
...
SP0A20_write_cmos_sensor(0xfd,0x01);
SP0A20_write_cmos_sensor(0xd3,0x77);
SP0A20_write_cmos_sensor(0xd4,0x70);
SP0A20_write_cmos_sensor(0xd5,0x5a);
SP0A20_write_cmos_sensor(0xd6,0x40);
SP0A20_write_cmos_sensor(0xd7,0x77);
SP0A20_write_cmos_sensor(0xd8,0x79);
SP0A20_write_cmos_sensor(0xd9,0x5a);
...
SP0A20_write_cmos_sensor(0x10,0x7e);
SP0A20_write_cmos_sensor(0x11,0x7e);
SP0A20_write_cmos_sensor(0x12,0x7e);
SP0A20_write_cmos_sensor(0x13,0x7e);
...
BOOL SP0A20_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			SP0A20_write_cmos_sensor(0xfd,0x02);											
			SP0A20_write_cmos_sensor(0x26,0xc2);																
		...
		case AWB_MODE_DAYLIGHT: //sunny
			...
			SP0A20_write_cmos_sensor(0x32,0x05);															
			SP0A20_write_cmos_sensor(0xfd,0x02);															
			SP0A20_write_cmos_sensor(0x26,0xb0);																
			SP0A20_write_cmos_sensor(0x27,0xa0);	//d0																
			SP0A20_write_cmos_sensor(0xfd,0x00);
			SP0A20_write_cmos_sensor(0xe7,0x03);
			SP0A20_write_cmos_sensor(0xe7,0x00);			
			break;
		...
		case AWB_MODE_INCANDESCENT: //office
			...
			SP0A20_write_cmos_sensor(0x32,0x05);															
			SP0A20_write_cmos_sensor(0xfd,0x02);															
			SP0A20_write_cmos_sensor(0x26,0x84);																
		...
		case AWB_MODE_FLUORESCENT:
			...
			SP0A20_write_cmos_sensor(0x32,0x05);															
			SP0A20_write_cmos_sensor(0xfd,0x02);															
			SP0A20_write_cmos_sensor(0x26,0x98);	//95															
			SP0A20_write_cmos_sensor(0x27,0xc0);	//ba														
			SP0A20_write_cmos_sensor(0xfd,0x00);
			SP0A20_write_cmos_sensor(0xe7,0x03);
			SP0A20_write_cmos_sensor(0xe7,0x00);	
	      break;
...
BOOL SP0A20_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		case AE_EV_COMP_n13:
			SP0A20_write_cmos_sensor(0xfd, 0x01);
			SP0A20_write_cmos_sensor(0xdb, 0xc8);
			break;

		case AE_EV_COMP_n10:
			SP0A20_write_cmos_sensor(0xfd, 0x01);
			SP0A20_write_cmos_sensor(0xdb, 0xd8);
			break;

		case AE_EV_COMP_n07:
			SP0A20_write_cmos_sensor(0xfd, 0x01);
			SP0A20_write_cmos_sensor(0xdb, 0xe8);
			break;

		case AE_EV_COMP_n03:
			SP0A20_write_cmos_sensor(0xfd, 0x01);
			SP0A20_write_cmos_sensor(0xdb, 0xf8);
			break;
